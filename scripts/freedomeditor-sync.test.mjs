...
import { compareVersions, findOfficialCodeApp, mergeSettingsText, releaseDecision, selectRelease, syncProfile } from './freedomeditor-sync.mjs';

function fixture(context) {
	const directory = mkdtempSync(path.join(os.tmpdir(), 'freedomeditor-sync-'));
